...
var genesisTXID = 'b502bc1dc42b07092b9187e92f70e32f9a53247feae16d821bebffa916af79ff';
var CONCURRENCY = 10;
...
var encodedData = require('soop').load('cannacore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('cannacore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('cannacore/lib/Address', {
